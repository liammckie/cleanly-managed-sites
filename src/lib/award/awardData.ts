  ...
  levels: [
    // Full-time Level 1
    {
      ...
      rates: {
        ...
        'public-holiday': { rate: 62.43, multiplier: 2.50 },
    ...
    // Full-time Level 2
    {
      ...
      rates: {
        ...
        'public-holiday': { rate: 64.50, multiplier: 2.50 },
    ...
    // Full-time Level 3
    {
      ...
      rates: {
        ...
        'public-holiday': { rate: 67.93, multiplier: 2.50 },
    ...
    // Part-time Level 1
    {
      ...
      rates: {
        ...
        'public-holiday': { rate: 66.17, multiplier: 2.30 },
    ...
    // Part-time Level 2
    {
      ...
      rates: {
        ...
        'public-holiday': { rate: 68.37, multiplier: 2.30 },
    ...
    // Part-time Level 3
    {
      ...
      rates: {
        ...
        'public-holiday': { rate: 72.00, multiplier: 2.30 },
    ...
    // Casual Level 1
    {
      ...
      rates: {
        ...
        'public-holiday': { rate: 68.67, multiplier: 2.20 },
    ...
    // Casual Level 2
    {
      ...
      rates: {
        ...
        'public-holiday': { rate: 70.95, multiplier: 2.20 },
    ...
    // Casual Level 3
    {
      ...
      rates: {
        ...
        'public-holiday': { rate: 74.72, multiplier: 2.20 },
