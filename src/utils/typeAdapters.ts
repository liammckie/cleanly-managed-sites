...
export function adaptQuoteToDTO(quote: any): QuoteDTO {
  return {
    ...
    marginAmount: quote.margin_amount || quote.marginAmount,
    overheadCost: quote.overhead_cost || quote.overheadCost,
    totalCost: quote.total_cost || quote.totalCost,
    ...
    contractLength: quote.contract_length || quote.contractLength,
    contractLengthUnit: quote.contract_length_unit || quote.contractLengthUnit,
...
export function adaptQuoteToApi(quote: any): any {
  return {
    ...
    contract_length: quote.contractLength || quote.contract_length || 0,
